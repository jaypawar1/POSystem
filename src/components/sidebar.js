  ...
  return (
	...
	<div className="h-full p-3 pt-1 space-y-2 w-60 bg-zinc-900 z-10 text-gray-100">
      ...
      <li className=" rounded-md text-gray-50">
			...
			<li>
				<Link rel="noopener noreferrer" href="/chat" className="flex items-center p-2 space-x-3 rounded-md">
					<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" className="w-5 h-5 fill-current text-gray-400">
			...
			<li>
				<Link rel="noopener noreferrer" href="/contacts" className="flex items-center p-2 space-x-3 rounded-md">
